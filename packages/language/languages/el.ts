  ...
  accountManagement: {
    ...
    sendEth: {
      error: {
        ...
        limitExceeded: Α => `Μπορείτε να στείλετε μόνο ${CUR[Α]} ${TL[Α]} ανά εβδομάδα, παρακαλούμε επιλέξτε ένα μικρότερο ποσό`,
      },
      ...
      note: Α => `Παρακαλώ σημειώστε: μπορείτε να μεταφέρετε μόνο ${CUR[Α]}${TL[Α]} την εβδομάδα εκτός Lndr`,
      warning: (Z, Α) => `Έχετε ${CUR [Α]} ${Z} υπόλοιπο ${CUR [Α]} ${TL[Α]} στο όριό σας`,
    },
    sendBcpt: {
      error: {
